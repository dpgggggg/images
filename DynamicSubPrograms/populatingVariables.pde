...
pic1 = loadImage("../image used/landscape/pic1.jpg"); //Dimensions: width:452, height: 300
pic2 = loadImage("../image used/portrait/983794168.jpg"); //Dimensions: width:929, height: 700
